...
if __name__ == '__main__':
    description = 'Save Ratings Tab Url'
    epilog = '''Usage: py save_ratings_urls.py -file_name FILENAME -path PATH -operation OPERATION'''
    file_name_help = 'Give already collected universities ratings url csv file name Example: "Universities_rating_urls.csv"'
    path_help = r'Give saved university rating tab url csv file path Example: "F:\Studies in Australia\Studies in Australia\2 - Get Universities or Institutions Tab url\01 - CSV Files\01 - Saved files"'
    operation_help = 'Give Save rating page operation name Example: "Save rating url"'
    ...
    # csv_file_path = r'F:\Studies in Australia\Studies in Australia\2 - Get Universities or Institutions Tab url\01 - CSV Files\01 - Saved files'
    # csv_file_name = csv_file_path + r'\Universities_rating_urls.csv'
    # operation = 'Save rating url'
    ...
    for index, valid_url in pd.read_csv(csv_file_name).iterrows():
        valid_url = valid_url['Rating url']
