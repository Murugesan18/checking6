...
if __name__ == '__main__':
    description = 'Save Campus Tab Url'
    epilog = '''Usage: py save_campus_urls.py -file_name FILENAME -path PATH -operation OPERATION'''
    file_name_help = 'Give already collected universities campus urls csv file name Example: "Universities_campus_urls.csv"'
    path_help = r'Give saved university campus tab url csv file path Example: "F:\Studies in Australia\Studies in Australia\2 - Get Universities or Institutions Tab url\01 - CSV Files\01 - Saved files"'
    operation_help = 'Give Save campus page operation name Example: "Save campus url"'
    ...
    # csv_file_name = csv_file_path + r'\Universities_campus_urls.csv'
    # operation = 'Save campus url'
    ...
    for index, valid_url in pd.read_csv(csv_file_name).iterrows():
        valid_url = valid_url['Campus url']
